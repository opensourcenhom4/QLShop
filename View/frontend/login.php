	               ...
	               <!-- danh mục sản phẩm -->
	                <div class="box-container">
	                    <div class="product-category">
	                        <div class="c_header"><span>Danh mục sản phẩm</span></div>
	                            <div id="product_category">
	                            <ul>
	                                <li>
	                                	<a href="#"><span>Danh mục 1</span></a>
	                                </li>   
	                                 <li>
	                                	<a href="#"><span>Danh mục 1</span></a>
	                                </li>   
	            	...
	            	<div class="box-container">
	                    <div class="product-category">
	                        <div class="c_header"><span>Sản phẩm theo hãng</span></div>
	                            <div id="product_category">
	                            <ul>
	                                <li>
	                                	<a href="#"><span>Hãng 1</span></a>
	                                </li>   
	                                 <li>
	                                	<a href="#"><span>Danh mục 1</span></a>
	                                </li>   
...
<!-- endcontent -->
	...
	<div class="container">
		<div class="row">
			...
			<div class="btg">
				<div class=" bt"><img src="img/lg1.jpg"></div>
				<div class=" bt"><img src="img/lg2.jpg"></div>
				<div class=" bt"><img src="img/lg4.jpg"></div>
				<div class=" bt"><img src="img/lg3.jpg"></div>
			</div>
