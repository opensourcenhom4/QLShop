		...
		<div class="card  border-primary">
			...
			<!-- neu muon upload duoc file, phai co thuoc tinh enctype="multipart/form-data" -->
				<form method="post" enctype="multipart/form-data" action="<?php echo $form_action; ?>">
					...
					<div class="form-group">
						<div class="row">
							<div class="col-md-2 text-right">Hãng</div>
							<div class="col-md-10">
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-10">
							<select name="fk_product_type_id">
								<option value="0"></option>
							<?php 
								//lay toan bo ban ghi trong tbl_category_product
								$category = $this->model->get_all("select * from tbl_product_type");
								foreach($category as $rows)
								{
							 ?>
								<option <?php if(isset($arr->fk_product_type_id)&&$arr->fk_product_type_id==$rows->pk_product_type_id){ echo "selected"; } ?> value="<?php echo $rows->pk_product_type_id; ?>"><?php echo $rows->c_name; ?></option>
							<?php } ?>
							</select>
							</div>
						</div>
					...
					<div class="form-group">
						<div class="row">
							<div class="col-md-2 text-right">Giá sale</div>
							<div class="col-md-10">
								<input type="text" name="price_sale" value="<?php echo isset($arr->price_sale)?$arr->price_sale:""; ?>" required class="form-control">
							</div>
						</div>
					</div>
					<!-- end form group -->
					...
					<div class="form-group">
						<div class="row">
							<div class="col-md-2 text-right">Kích cỡ có: </div>
							<div class="col-md-10">
